...
def main() -> None:
    ...
    with mlflow.start_run():
        ...
        mlflow.log_params({
            "min_bits": cfg["he"]["min_bits"],
            "max_bits": cfg["he"]["max_bits"],
            "duration": cfg["simulation"]["duration_minutes"],
        })
        ...
        mlflow.log_metric("avg_latency", df["latency"].mean())
        mlflow.log_metric("avg_bits", df["bits"].mean())
        mlflow.log_metric("mean_accuracy", df["accuracy"].mean())
        for artifact in ["results.csv", "plot_sensitivity_bits.png", "plot_latency_bits.png", "plot_accuracy_bits.png", "ledger.csv"]:
